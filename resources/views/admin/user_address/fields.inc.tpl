<div class="form-group">
	<label class="col-md-3 control-label" for="user_id">用户</label>
	<div class="col-md-9">
		<select name="user_id" class="select-model form-control" data-model="admin/member" data-text="{{username}}" data-params='{"f[role_id][in][]":"1"}' data-term="{{username}}" data-placeholder="请输入用户名" value="<{$_data.user_id}>"></select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-9">
		<input type="text" id="account_name" name="account_name" class="form-control" placeholder="请输入户名..." value="<{$_data.account_name}>">
	</div>
</div>
<div class="form-group">
	<label class="col-md-3 control-label" for="account_address">地址</label>
	<div class="col-md-9">
		<input type="text" id="account_address" name="account_address" class="form-control" placeholder="请输入地址..." value="<{$_data.account_address}>">
	</div>
</div>
<div class="form-group">
