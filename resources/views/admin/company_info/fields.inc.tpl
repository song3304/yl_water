...
<div class="form-group">
	<label class="col-md-3 control-label" for="contents">简介</label>
	<div class="col-md-9">
		<input type="hidden" id="type" name="type" value="<{$_data.type}>">
		<textarea id="contents" name="contents" class="form-control" placeholder="请输入简介..." style="height:200px;"><{$_data.contents}></textarea>
	</div>
</div>
